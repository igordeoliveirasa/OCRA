...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../repo/trunk/Native/libs/boost_v1.52 -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/SHA1.o: SHA1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../repo/trunk/Native/libs/boost_v1.52 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SHA1.o SHA1.cpp

${OBJECTDIR}/HMAC_SHA1.o: HMAC_SHA1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../repo/trunk/Native/libs/boost_v1.52 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HMAC_SHA1.o HMAC_SHA1.cpp
